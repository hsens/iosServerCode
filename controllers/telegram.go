...
func (idb *InDB) GetTelegram(c *gin.Context) {
	var (
		message structs.Telegram
		result gin.H
	)
	id := c.Param("id")
...
//to get one data with {id}
func (idb *InDB) GetTelegramImei(c *gin.Context) {
	var (
		message structs.Telegram
		result gin.H
	)
...
func (idb *InDB) GetAllTelegram(c *gin.Context) {
...
func (idb *InDB) CreateTelegram(c *gin.Context) {
	var (
		message structs.Telegram
		result gin.H
	)
...
// delete data with {id}
func (idb *InDB) DeleteTelegram(c *gin.Context) {
	var (
